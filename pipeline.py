...
def _parse_postnord_sheet(ws):
    """Three-strategy PostNord parser (anchored → full-sheet scan → numeric region)."""
    result = {}

    # Strategy 1: named service anchors
    ...
    log.warning('PostNord: all 3 strategies failed on sheet "%s"', ws.title)
    return result
